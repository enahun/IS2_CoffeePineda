...
namespace WebApplicationBodegaPineda.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idProveedor,nombreProveedor,apellidoProveedor,telefono,domicilio,rtn,claveIhcafe")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idProveedor,nombreProveedor,apellidoProveedor,telefono,domicilio,rtn,claveIhcafe")] Proveedore proveedore)
        {
            if (ModelState.IsValid)
            {
